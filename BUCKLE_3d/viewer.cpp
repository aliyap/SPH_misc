...
#endif
{
    ...
    connect(createTimer, SIGNAL(timeout()), this, SLOT(rotateWorld()));
    createTimer->start(1000/20);
}
...
QMatrix4x4 Viewer::getCameraMatrix() {
    ...
    QVector3D cameraPosition = cameraTransformation * QVector3D(0, 0.0, 1.7);
...
void Viewer::rotateWorld() {
    // Todo: Ask if we want to keep this.
    modelMatrix.rotate(2, 0, 1, 0);
}
